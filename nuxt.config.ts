  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: 'Öz Next Sosyal' },
        ...
        { property: 'og:site_name', content: 'Öz Next Sosyal' },
        { name: 'twitter:site', content: '@oznextsosyal' },
        { property: 'twitter:image', content: 'https://oznextsosyal.com/oznextsosyal-og.png' },
